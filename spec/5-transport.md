...
|------------|----------|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `schema`   | Yes      | `int`    | Framing format version. Allows the framing format to evolve without breaking existing receivers. Receivers MUST reject any Frame whose `schema` value is not supported, without attempting to parse the `payload`.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Field           | Required | Type     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|-----------------|----------|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `schema`        | Yes      | `int`    | Schema version. Receivers MUST reject any envelope whose `schema` value is not supported, without attempting to parse or decrypt the `payload`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
arrived within an implementation-defined timeout, freeing the associated buffer. Receivers MUST also enforce an
implementation-defined maximum on the number of incomplete messages concurrently awaiting reassembly; new
fragments that would exceed this limit MUST be dropped. These limits prevent memory exhaustion from a sender
that opens many partial messages and never completes them.
