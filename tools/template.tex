...
$fonts.latex()$
$font-settings.latex()$
% Emoji font fallback for Unicode pictographs.
% XeTeX + xdvipdfmx cannot embed color emoji tables (COLR/sbix) reliably —
% color fonts load but produce blank glyphs in the PDF. We prefer the
% monochrome Noto Emoji, which uses plain outlines and renders correctly.
\usepackage{fontspec}
