...
class LibbleModuleImpl : LibbleModule {

    private val log = Logger.of(this::class)

    override val metrics: LibbleMetrics = LibbleMetrics()
    override val requests: Channel<LibbleEvent.RequestReceived> = Channel(
        capacity = 1000,
    ...
    override fun setEventHandler(handler: suspend (LibbleEvent) -> Unit): LibbleModule {
     ...
     */
    override suspend fun peerIdForPeripheral(peripheralId: String): String? =
