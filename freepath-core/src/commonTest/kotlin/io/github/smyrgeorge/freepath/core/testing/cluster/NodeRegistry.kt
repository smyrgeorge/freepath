 ...
 * - `PeerActor` is keyed by `"ownerPeerId:remotePeerId"` → resolved by owner peerId via [byPeerId].
 *
 ...
 * is what triggers `PeerActor` creation). Plain maps are therefore safe for this JVM harness.
 */
