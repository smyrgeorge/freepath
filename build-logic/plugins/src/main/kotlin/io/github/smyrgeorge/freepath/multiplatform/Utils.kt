package io.github.smyrgeorge.freepath.multiplatform
...
object Utils {
     ...
     * the method returns a default list containing only the default targets.
     *
    ...
    fun targetsOf(project: Project): List<String> =
        ...
        } ?: listOf("jvm") // Default for local development.
}